...
//        car = new Car("Model name 1", "Make name 1", 27712, 2016, new BigDecimal(120000), "Condition 1", "Color 1", "Transmission 1", "Fuel type 1", "Description 1", new BigDecimal(100000), false);
//        car1 = new Car("Model name 2", "Make name 2", 30000, 2014, new BigDecimal(100000), "Condition 2", "Color 2", "Transmission 2", "Fuel type 2", "Description 2", new BigDecimal(90000), false);
//    }
//
//    @Test
