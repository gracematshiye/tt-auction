...
public class User {
    ...
    public User(int userId, String username, String password, String firstName, String lastName, String dateOfBirth, String emailAddress, String cellPhoneNumber, String homeAddress) {
        this.userId = userId;
